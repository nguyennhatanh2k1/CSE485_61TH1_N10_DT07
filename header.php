...
<div id="blue_bar">
	<form method="get" action="search.php">
		<div style="width: 800px;margin:auto;font-size: 30px;">
			<a style="text-decoration: none; color:white" class="none-decoration kg-happy-solid" href="index.php"><img style="width: 35px;" class="nav-logo-img" src="./logo.png" alt=""> MyBlog</a>
			...
			<?php if(isset($USER)): ?>
				...
				<a href="logout.php">
				<span style="font-size:20px;float: right;margin:10px;color:white;">Logout</span>
				</a>
