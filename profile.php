...
$login = new Login();
$_SESSION['myblog_userid'] = isset($_SESSION['myblog_userid']) ? $_SESSION['myblog_userid'] : 0;

$user_data = $login->check_login($_SESSION['myblog_userid'], false);
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if (isset($_POST['first_name'])) {
		...
		$settings_class->save_settings($_POST, $_SESSION['myblog_userid']);
	} else {
	...
	<div style="width: 800px;margin:auto;min-height: 400px;">
		...
		<div style="background-color: white;text-align: center;color: #405d9b">
			...
			<div style="font-size: 20px;color: black;">
				...
				<a href="../myblog/phpchat/phpchat/user.php">
					<div style="margin-left:500px;width:100px;" id="menu_buttons">Chat</div>
				</a>
				</div>
			...
			<?php
			if ($user_data['userid'] == $_SESSION['myblog_userid']) {
