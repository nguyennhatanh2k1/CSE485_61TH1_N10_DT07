...
<main class="container mt-5">
    ...
    <form action="" method="post">
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" disabled value="<?php echo $row_current['userid'] ?>" class="form-control" id="userid" name="userid">
            </div>
        </div>
        <div class="mb-3 row">
...
<?php
    ...
    if(isset($_POST['btnLuu'])) {
        ...
        $sql_update = "update db_myblog set userid = '$userid', first_name = '$userfname', last_name = '$userlname', gender = '$usergender', email = '$useremail', password ='$userpassword' where id = '$id'";
